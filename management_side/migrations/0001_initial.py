    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('delivered', 'delivered'), ('out of date', 'out of date')], default='', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            name='Issue',
            fields=[
                ('issue_id', models.CharField(default='', max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cat_id', models.ManyToManyField(to='management_side.Category')),
                ('floor_id', models.ManyToManyField(to='management_side.Floor')),
                ('shelf_id', models.ManyToManyField(to='management_side.Shelf')),
            ],
        ),
        migrations.AddField(
            model_name='book',
